...
import static com.example.timelineapi.infrastructure.constant.AuditionConstants.X_AGENT_NAME;
import static com.example.timelineapi.infrastructure.constant.AuditionConstants.X_CORRELATION_ID;
...
public class CorrelationIdInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        //NewRelic.addCustomParameter(X_CORRELATION_ID, correlationId);
        //NewRelic.addCustomParameter(X_AGENT_NAME, agentName);
        return true;
    }
